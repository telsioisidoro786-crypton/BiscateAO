...
import { signIn, signUpEmail, authEnabled, GROK_PROVIDERS } from "@/lib/auth/client";
      ...
      <section className="space-y-3">
        ...
        <div className="grid gap-2 sm:grid-cols-2">
          {GROK_PROVIDERS.map((provider) => {
            const isGoogle = provider.providerId === "google";
            const isGithub = provider.providerId === "github";
            const hasCredentials = isGoogle
              ...
              : isGithub
                ...
                : true; // email/password always available
            ...
            return (
              <Button
                ...
                onClick={() => hasCredentials ? handleOAuthSignIn(provider.providerId) : undefined}
                className={cn(
              ...
              >
                ...
                {!hasCredentials && (
                  <span className="absolute inset-0 flex items-center justify-center">
                    <span className="text-xs text-muted">Configure no Supabase</span>
                  </span>
                )}
                {provider.label}
              </Button>
